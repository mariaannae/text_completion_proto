...
})({"bXcXW":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "0b21f5e8e57c8f66";
"use strict";
...
},{}],"9uE16":[function(require,module,exports) {
...
async function main() {
    ...
    //   },
    // );
    const engine = await _webLlm.CreateMLCEngine(model_qwen05, {
        appConfig: appConfig,
        initProgressCallback: initProgressCallback,
        logLevel: "INFO"
    });
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["bXcXW","9uE16"], "9uE16", "parcelRequire90c9")

//# sourceMappingURL=Qwen_0_5.e57c8f66.js.map
