...
})({"fuBJB":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "5787b62d43374948";
"use strict";
...
},{}],"9ksyo":[function(require,module,exports) {
...
async function main() {
    ...
    //   },
    // );
    const engine = await _webLlm.CreateMLCEngine(model_qwen3, {
        appConfig: appConfig,
        initProgressCallback: initProgressCallback,
        logLevel: "INFO"
    });
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["fuBJB","9ksyo"], "9ksyo", "parcelRequire90c9")

//# sourceMappingURL=Qwen_3.43374948.js.map
